...
class BleDataCollector(nrf_ble_driver.BLEDriverObserver, nrf_ble_driver.BLEAdapterObserver):
    ...
    def open(self, icid = 'NRF52'):
        ...
        if icid == 'NRF51':
            ...
            ble_config = nrf_ble_driver.BLEConfigCommon(vs_uuid_count=40)
            self.adapter.driver.ble_cfg_set(nrf_ble_driver.BLEConfig.uuid_count, ble_config)
